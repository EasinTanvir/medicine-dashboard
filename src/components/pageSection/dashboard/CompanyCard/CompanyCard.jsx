...
const CompanyCard = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-purple-500 to-indigo-600 rounded-t-2xl"></div>

      {/* Header */}
      <div className="flex items-center justify-between mt-2">
        <div className="flex items-center gap-3">
          <MdOutlineBusiness className="text-purple-500 w-10 h-10" />
          <div>
      ...
      {/* Bottom Border */}
      <div className="absolute bottom-0 left-0 w-full h-1 bg-linear-to-r from-indigo-600 to-purple-500 rounded-b-2xl"></div>
    </Link>
  );
};
